...
export default function LastingImpression() {
    return (
        <div className="bg-gradient-to-r from-indigo-500 my-32 to-blue-500 text-white rounded-3xl px-72 py-24 max-w-7xl mx-auto flex items-center justify-between">
            <div className="space-y-4 text-center">
                <h2 className="section-head !text-white !leading-tight">
